...
* *hotels.csv* - первоначальные данные для исследования с учебной платформы Skillfactory;
...
*   Основой интерпретатор - Python 3.10.11;
...
Проект c корректным выполнением кейса ["Рейтинг отеля по данным сайта Booking"]().
...
**LightAutoML** - <font color='LightSeaGreen'>**11.78034948**</font>;
